  ...
  return (
    <section id='about' className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'} w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10`}>
      ...
      <div className='flex flex-col justify-center items-start gap-8'>
        ...
        <h1 data-aos='zoom-in' data-aos-delay='200' className='text-black text-[40px] font-semibold leading-10 dark:text-white'>We Help Clients Buy And Sell Houses Since 2001</h1>
        <p data-aos='zoom-in' data-aos-delay='400' className='text-x1 text-gray-600 dark:text-white text-justify'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Repellat, sit porro non facere minima recusandae commodi quisquam illo, error deserunt dolore. Nam assumenda blanditiis ullam incidunt?</p>
